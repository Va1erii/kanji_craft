...
/// Syncs admin-only state (import history, review decisions) between
/// the Remote `admin` schema and local Drift.
///
/// Raw data tables are local-only — they are rebuilt from source files
/// via [IngestionService], not pulled from Remote.
