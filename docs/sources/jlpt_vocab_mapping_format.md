...
This resolves the "Eki Problem" — see [ph2_5_vocabulary_extraction.md §JLPT Level Strategy](../pipeline/ph2_5_vocabulary_extraction.md#jlpt-level-strategy).
...
- [ph2_5_vocabulary_extraction.md](../pipeline/ph2_5_vocabulary_extraction.md) — How `source_vocab_levels` feeds into `vocabulary.min_jlpt_level`
