...
| `unknown` | — | Fallback for unclassified positions. Includes KanjiVG's `tarec` (complement of tare) and `nyoc` (complement of nyo) — the enclosed content inside a wrapping radical |
