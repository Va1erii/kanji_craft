...
2. **Read existing docs** in `docs/domain/` for context on related groups and to stay consistent with established conventions, naming, and cross-references.
...
4. **Write the file** to `docs/domain/<group>.md`.
